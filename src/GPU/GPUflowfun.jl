...
function ppfuncosthe_gpu(p0, ps, qs, k, Ek, T)::Float32
    (
        k *
        csch(Ek / (2 * T))^2 *
        csch((Ek - p0) / (2 * T))^2 *
...
function ppfuncostheps1_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        (Ek2 + k - ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function ppfuncostheps2_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        (Ek2 + k - ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function ppfuncostheps3_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    -(
        k *
        qsmax^3 *
        csch(Ek / (2 * T))^2 *
...
function ppfuncostheps4_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    -(
        k *
        qsmax^3 *
        csch(Ek / (2 * T))^2 *
...
function ppfuncostheps5_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        (-Ek2 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function ppfuncostheps6_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        (-Ek2 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function ppfuncostheps7_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        csch(Ek / (2 * T))^2 *
        csch((Ek - p0) / (2 * T))^2 *
...
function ppfuncostheps8_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        csch(Ek / (2 * T))^2 *
        csch((Ek - p0) / (2 * T))^2 *
...
function ppfuncostheps9_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        (-Ek2 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function ppfuncostheps10_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        csch(Ek / (2 * T))^2 *
        csch((Ek - p0) / (2 * T))^2 *
...
function ppfuncostheps11_gpu(p0, ps, qsmax, k, Ek, Ek2, T)::Float32
    (
        k *
        (-Ek2 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncosthe1_gpu(p0, ps, qs, k, Ek, T)::Float32
    (
        k *
        csch(Ek / (2 * T)) *
        csch((Ek + p0) / (2 * T)) *
...
function pmfuncosthe2_gpu(p0, ps, qs, k, Ek, T)::Float32
    (
        k *
        csch(Ek / (2 * T)) *
        csch((Ek + p0) / (2 * T)) *
...
function pmfuncostheps1_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (Ek1 + k - ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps2_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (-2 * k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps3_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        qsmax^3 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps4_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (Ek1 + k - ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps5_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (-2 * k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps6_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (Ek1 + k - ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps7_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        qsmax^3 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps8_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (Ek1 + k - ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps9_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        qsmax^3 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps10_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (-Ek1 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps11_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        csch(Ek / (2 * T))^2 *
        csch((Ek + p0) / (2 * T))^2 *
...
function pmfuncostheps12_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (-Ek1 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps13_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        qsmax^3 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps14_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (-Ek1 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps15_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        csch(Ek / (2 * T))^2 *
        csch((Ek + p0) / (2 * T))^2 *
...
function pmfuncostheps16_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (-Ek1 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
...
function pmfuncostheps17_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        csch(Ek / (2 * T))^2 *
        csch((Ek + p0) / (2 * T))^2 *
...
function pmfuncostheps18_gpu(p0, ps, qsmax, k, Ek, Ek1, T)::Float32
    (
        k *
        (-Ek1 + k + ps + qsmax)^2 *
        csch(Ek / (2 * T))^2 *
