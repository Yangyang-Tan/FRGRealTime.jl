...
twopointReminmax =
    getmassmin(gettwopointminfun, -0.0001, 0.0001, N_kernels = 4, N_iters = 12)
...
writedlm(joinpath(path,"N=2/redataN=2.dat"),redata_twopoint)
writedlm(joinpath(path,"N=2/imdataN=2.dat"),imdata_twopoint)
writedlm(joinpath(path,"N=2/p0dataN=2.dat"),p0grid_Tc)
