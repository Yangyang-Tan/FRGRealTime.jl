...
getlambda(1.779445)
lambdaα=getmassmin(getlambda, 0.4141105, 0.41413, N_kernels = 4, N_iters = 30)[2]
getlambda(lambdaα)
...
Tcminmax=getmassmin(getTcfun, 132.94, 133.1, N_kernels = 4, N_iters = 10)
